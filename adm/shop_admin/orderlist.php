...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="th_odrall" >매출전환금액($)</th>
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td rowspan="2" class="td_numsum"><?= number_format($row['od_cart_price'],2)?></td>

        <td ><?php echo $row['od_settle_case'] ?></td>
		<td rowspan="2" style="text-align:right;padding-right:10px;"><?=number_format($row['upstair'],2)?></td>
    ...
    <tr class="orderlist">
		...
		<td><?php echo number_format($tot_pv); ?></td>
        <td></td>
		<td></td>
