...
<section class='breadcrumb'>
	<ol style='width:50%'>
		<li class="active title" data-i18n="dashboard.메인화면"><?=$title?></li>
		<li class='home'><i class="ri-home-4-line"></i><a href="<?php echo G5_URL; ?>" data-i18n='dashboard.홈'>Home</a></li>
	...
	<?}?>
		...
		<div class="col-sm-12 col-12 content-box round primary">
			...
			<div class="incard">
				...
				<dd>
					<?= $member['mb_recommend'] ? $member['mb_recommend']:'-'; ?>
				</dd>
			</div>
			<div class="incard">
